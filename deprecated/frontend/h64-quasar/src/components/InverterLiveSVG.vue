...
// import { Tween } from 'gsap/gsap-core/esm/Tween';
...
let anim_load: gsap.core.Tween, anim_pv: gsap.core.Tween,
  anim_battery_charge: gsap.core.Tween, anim_battery_discharge: gsap.core.Tween,
  anim_grid_sell: gsap.core.Tween, anim_grid_buy: gsap.core.Tween,
  pv_state = 'down',
  grid_state = 'buy',
...
//   const pv_arrow = document.querySelector('#current-power-arrow-pv');
//   if (pv_arrow) {
//     pv_arrow.classList.remove('hidden');
//   }
//   pv_state = 'up';
// }
...
//   const buy_arrow = document.querySelector('#current-power-arrow-grid-buy');
//   const sell_arrow = document.querySelector('#current-power-arrow-grid-sell');
//   if (buy_arrow) {
//     buy_arrow.classList.add('hidden');
//   }
//   if (sell_arrow) {
//     sell_arrow.classList.remove('hidden');
//   }
//   grid_state = 'sell';
// }
...
function gridBuy() {
  ...
  const buy_arrow = document.querySelector('#current-power-arrow-grid-buy');
  if (sell_arrow) {
    sell_arrow.classList.add('hidden');
  }
  if (buy_arrow) {
    buy_arrow.classList.remove('hidden');
  }
  grid_state = 'buy';
}
...
//   const discharge_arrow = document.querySelector('#current-power-arrow-battery-discharge');
//   const charge_arrow = document.querySelector('#current-power-arrow-battery-charge');
//   if (discharge_arrow) {
//     discharge_arrow.classList.add('hidden');
//   }
//   if (charge_arrow) {
//     charge_arrow.classList.remove('hidden');
//   }
...
function batteryDischarge() {
  ...
  const discharge_arrow = document.querySelector('#current-power-arrow-battery-discharge');
  if (charge_arrow) {
    charge_arrow.classList.add('hidden');
  }
  if (discharge_arrow) {
    discharge_arrow.classList.remove('hidden');
  }
  battery_state = 'discharge';
}
...
function loadUp() {
  ...
  const load_arrow = document.querySelector('#current-power-arrow-load');
  if (load_arrow) {
    load_arrow.classList.remove('hidden');
  }
  load_state = 'up';
}
...
//   const load_arrow = document.querySelector('#current-power-arrow-load');
//   if (load_arrow) {
//     load_arrow.classList.add('hidden');
//   }
//   load_state = 'down';
// }

function restartOthersFrom(type: string) {
  if (type === 'pv') {
